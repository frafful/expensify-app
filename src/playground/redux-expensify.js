...
const newItem = store.dispatch(addExpense({ description: 'Rent', amount: 500, createdAt: -1000 }));
const newItem2 = store.dispatch(addExpense({ description: 'Coffee', amount: 300, createdAt: 1000 }));
